...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Votos de la asamblea de prueba eliminados. Los tokens del gestor no se devuelven automáticamente (consumo típico: LOPD en sesión, WhatsApp masivo, etc.).',

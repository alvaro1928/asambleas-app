            ...
            <div className="space-y-6">
              <div className="flex items-center gap-2 rounded-3xl bg-amber-100 dark:bg-amber-900/30 px-4 py-3 border border-amber-200 dark:border-amber-800">
                ...
                <p className="text-sm font-medium text-amber-800 dark:text-amber-200">
                  No hay suficientes tokens (créditos) en tu billetera. Se consumen sobre todo cuando los votantes aceptan LOPD en la sesión pública y en envíos masivos u otras operaciones de pago según el caso; compra más créditos.
                </p>
              </div>
              <ComprarTokensCTA

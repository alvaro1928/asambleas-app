                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          {preguntaActualObj.opciones.map((opc) => (
                            <button
                              ...
                              aria-pressed={opcionSeleccionada === opc.id}
                              className={`w-full px-4 py-2.5 rounded-2xl border-2 text-sm font-semibold transition-all duration-150 ${
                                opcionSeleccionada === opc.id
                                  ? 'border-indigo-500 bg-indigo-600 text-white shadow-lg ring-2 ring-indigo-300 dark:ring-indigo-700'
                                  : 'border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:border-indigo-400 hover:bg-indigo-50/60 dark:hover:bg-indigo-900/20'
                              }`}
                            >

...
- **Asamblea de pruebas (sandbox):** desde el listado de Asambleas, el botón **"Probar en entorno de pruebas"** crea una asamblea de demostración (10 unidades, 2 preguntas, activada). No consume tokens; el acta lleva marca de "DEMO - SIN VALIDEZ LEGAL". Incluye las mismas funcionalidades y diseño que una asamblea real: **quórum automático por presencia activa**, **acceso de asistente delegado**, secciones **colapsables** en Acceso Público y en la página de Acceso, y panel **Quórum y Participación** con estado en vivo. Puedes elegir **Unidades de demostración** (10 cuentas test) o **Unidades reales del conjunto** y **gestionar unidades** desde el enlace en el panel de la asamblea.
...
- **Quórum automático por presencia:** la presencia para quórum se calcula con heartbeat, actividad, reconexión y evento de voto. La sesión autenticada solo mantiene UX y **no** se usa como prueba de presencia. El cálculo oficial es por **coeficiente representado** y evita duplicados por múltiples pestañas/dispositivos.
- **Verificación manual de respaldo:** el botón/manual de asistencia se mantiene solo como contingencia administrativa o soporte legal, sin ser el flujo principal.
- **Acta con snapshots históricos:** el sistema registra snapshots de quórum por hitos (apertura/cierre de asamblea, apertura/cierre de votación, cambios relevantes) para que el acta use estado histórico auditado, no recálculo improvisado al final.

        ...
        <div className="p-6 grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-none space-y-2 text-sm text-slate-400">
              ...
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-0.5 shrink-0">✓</span>
                <span><strong className="text-slate-300">Poderes</strong> — Registrar delegaciones de voto por unidad; búsqueda por torre+número o solo número cuando el conjunto no usa torre; límite configurable por apoderado.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-0.5 shrink-0">✓</span>
